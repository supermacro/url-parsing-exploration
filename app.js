...
var author$project$Part1$Model = function (input) {
	return {input: input};
};
var author$project$Part1$init = author$project$Part1$Model('');
var author$project$Part2$Post$Model = function (visible) {
	return {visible: visible};
};
var elm$core$Basics$False = {$: 'False'};
var author$project$Part2$Post$init = author$project$Part2$Post$Model(false);
var author$project$Main$init = A2(author$project$Main$Model, author$project$Part1$init, author$project$Part2$Post$init);
var author$project$Part1$update = F2(
	function (msg, _n0) {
		var str = msg.a;
		return author$project$Part1$Model(str);
	});
...
var author$project$Part2$Post$update = F2(
	function (_n0, model) {
		return author$project$Part2$Post$Model(!model.visible);
	});
	...
	function (msg, model) {
		if (msg.$ === 'Pt1') {
			...
			return _Utils_update(
				model,
				{
					pt1: A2(author$project$Part1$update, pt1Msg, model.pt1)
				});
		} else {
			var pt2Msg = msg.a;
			return _Utils_update(
				model,
				{
					pt2: A2(author$project$Part2$Post$update, pt2Msg, model.pt2)
				});
		}
	});
var author$project$Main$Pt1 = function (a) {
	return {$: 'Pt1', a: a};
};
var author$project$Main$Pt2 = function (a) {
	return {$: 'Pt2', a: a};
};
var author$project$Part1$Input = function (a) {
	return {$: 'Input', a: a};
};
...
var author$project$Part1$md = A2(
...
var author$project$Part1$view = function (model) {
	var urlInfo = function () {
		var _n0 = elm$url$Url$fromString(model.input);
		if (_n0.$ === 'Nothing') {
			return elm$core$List$singleton(
				elm$core$String$isEmpty(model.input) ? 'enter something!' : 'Invalid URL');
		} else {
			var url = _n0.a;
			var protocol = function () {
				var _n1 = url.protocol;
				if (_n1.$ === 'Http') {
					return 'http';
				} else {
					return 'https';
			...
			var port_ = A2(
				...
				'80 (default port)',
				A2(elm$core$Maybe$map, elm$core$String$fromInt, url.port_));
			return _List_fromArray(
				[
					'Protocol: ' + protocol,
					'Host: ' + url.host,
					'Port: ' + port_,
					'Path: ' + url.path,
					'Query: ' + A2(elm$core$Maybe$withDefault, 'none', url.query),
					'Fragment:' + A2(elm$core$Maybe$withDefault, 'none', url.fragment)
				]);
		}
	}();
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('part-1')
			]),
		_List_fromArray(
			[
				author$project$Part1$md,
				A2(
				elm$html$Html$input,
				_List_fromArray(
					[
						elm$html$Html$Attributes$type_('text'),
						elm$html$Html$Attributes$class('browser-input'),
						elm$html$Html$Events$onInput(author$project$Part1$Input)
					]),
				_List_Nil),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('url-info')
					]),
				A2(
					elm$core$List$map,
					function (str) {
...
var author$project$Part2$Post$ToggleVisibility = {$: 'ToggleVisibility'};
var author$project$Part2$Post$md = A2(
	elm_explorations$markdown$Markdown$toHtml,
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('content')
...
var author$project$Part2$Post$view = function (model) {
	var content = model.visible ? author$project$Part2$Post$md : A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Part2$Post$ToggleVisibility)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('Ok Got It')
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Click above to continue')
					]))
			]));
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('part-2')
			]),
		_List_fromArray(
			[content]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Url |> Parse |> Route')
					])),
				A2(
				elm$html$Html$map,
				author$project$Main$Pt1,
				author$project$Part1$view(model.pt1)),
				A2(
				elm$html$Html$map,
				author$project$Main$Pt2,
				author$project$Part2$Post$view(model.pt2))
			]));
};
